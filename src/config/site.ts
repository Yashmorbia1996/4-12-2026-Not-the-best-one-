export const siteConfig = {
  ...
  role: "Lead Mechanical Engineer ΓÇö Product Development & Manufacturing",
  ...
  description: "Yash Morbia ΓÇö Lead Mechanical Engineer focused on NPI, regulated medical devices, and scalable manufacturing.",
